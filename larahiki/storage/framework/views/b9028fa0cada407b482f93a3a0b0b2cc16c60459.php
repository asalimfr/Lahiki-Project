...
<!-- general form elements -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo Form::open(array('route' => 'utilisateur.store','method'=>'POST')); ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                    <?php echo Form::label('etablissement_id', 'Etablissement'); ?>       
                         ...
                         <input class="input-signtype" name="etablissement_text"  value="" 
                            id="etablissement_autocomplete" type="text" placeholder="Etablissement">
                             <input name="etablissement_id" type="hidden" id="etablissement_id" value=""/>
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::radio('is_accueilleur', '1', false); ?> Oui &nbsp;&nbsp; <?php echo Form::radio('is_accueilleur', '0', true); ?> Non
