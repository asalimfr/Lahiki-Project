...
<!-- general form elements -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Modifier un département</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            
            <?php echo Form::model($departement, ['method' => 'PATCH','route' => ['departement.update', $departement->id]]); ?>
              ...
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <?php echo Form::select('pays_id', $paysSelect, $departement->pays_id,['class' => 'form-control']); ?>
