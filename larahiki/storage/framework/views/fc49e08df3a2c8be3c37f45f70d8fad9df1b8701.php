...
<!-- general form elements -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Ajouter une nouvelle rencontre</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo Form::open(array('route' => 'rencontre.store','method'=>'POST')); ?>

              <div class="box-body">
                <div class="form-group">
                    <?php echo Form::label('date_rencontre', 'Date rencontre'); ?>                  
                    <?php echo Form::date('date_rencontre', null, array('class' => 'form-control')); ?>

                </div>
                <div class="form-group">
                    <?php echo Form::label('accueillant_id', 'Email de l\'accueillant'); ?>       
                    <?php echo Form::select('acceuillant_id', $accueillantSelect, null, ['class' => 'form-control']); ?>

                </div>
                <div class="form-group">
                    <?php echo Form::label('accueilli_id', 'Email de l\'accueilli'); ?>       
                    <?php echo Form::select('accueilli_id', $accueilliSelect, null, ['class' => 'form-control']); ?>

                </div>

                <div class="form-group">
                    <?php echo Form::label('lieu_rencontre', 'Lieu de la rencontre'); ?>                  
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::radio('is_accueilli', '1', false); ?> Oui &nbsp;&nbsp; <?php echo Form::radio('is_accueillli', '0', true); ?> Non
