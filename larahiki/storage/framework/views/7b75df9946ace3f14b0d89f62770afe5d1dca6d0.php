...
<!-- general form elements -->
          <div class="box box-primary">
            ...
            <?php echo Form::model($actualite, ['method' => 'PATCH','route' => ['actualite.update', $actualite->id]]); ?>
              ...
              <div class="box-body">
                ...
                <a class="btn color-4 size-2 hover-7 be-ava-user style-2" id="lfm" data-input="thumbnail" data-preview="holder">
                    <img id="holder" src="<?php echo e(($actualite->media != null ? $actualite->media : '/img/ava_10.jpg' )); ?>" style="margin-top:15px;max-height:100px;">                  
                  <i class="fa fa-picture-o"></i> Choisir image                  
                  </a>
                  <input id="thumbnail" class="form-control" type="hidden" name="media" value="<?php echo e(($actualite->media != null ? $actualite->media : '/img/ava_10.jpg' )); ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::date('date_publication', date('Y-m-d', strtotime($actualite->date_publication)), array('class' => 'form-control')); ?>

                </div>
                <div class="form-group">
                    <?php echo Form::label('date_expiration', 'Date expiration'); ?>                  
                    <?php echo Form::date('date_expiration', date('Y-m-d', strtotime($actualite->date_expiration)), array('class' => 'form-control')); ?>

                </div>
                <div class="form-group">
                    <?php echo Form::label('is_accueil', ' Afficher accueil'); ?> <br>                  
                    <?php echo e(Form::radio('is_accueil', '1', ($actualite->is_accueil == '1'))); ?> Oui &nbsp;&nbsp; <?php echo e(Form::radio('is_accueil', '0', ($actualite->is_accueil == '0'))); ?> Non
                </div>
                <div class="form-group">
